                ...
                case "2": {
                    ...
                    if (user != null && user.getRole().equals("OWNER")) {
                        ...
                        while (true) {
                            ...
                            System.out.println("| 2 for create restaurant                   |");
                            System.out.println("| 3 for update Restaurant                   |");
                            System.out.println("| 4 for delete restaurant                   |");
                            System.out.println("| 5 for get all details of restaurant       |");
                            System.out.println("| 6 for add food Items in restaurant        |");
                            System.out.println("| 7 for update food item                    |");
                            System.out.println("| 8 for update order status                 |");
                            System.out.println("| 9 get all orders of restaurant            |");
                            ...
                            switch (inp2) {
                                case "1":
                                    ...
                                    System.out.printf("|UserId :- %-15s |\n", user.getId());
                                    System.out.printf("|Email  :- %-15s |\n", user.getEmail());
                                    System.out.println("--------------------------------------");
                                    break;
                                case "2": {
                        ...
                        while (true) {
                            ...
                            switch (inp2) {
                                ...
                                case "3":
                                    ...
                                    System.out.printf("| %-15s    %-15s  %-18s|\n", "CustomerId", "Food Name", "Food price");
                                    System.out.println("+-------------------------------------------------+");
                                    System.out.printf("| %-5s    %-15s  %-10s|\n", "Restaurant Id", "order Id", "order Status");
                                    for (Order order : orderList) {
                                        System.out.printf("| %-5s    %-15s  %-10s|\n", order.getRestaurantId(), order.getId(), order.getStatus());
                                        System.out.println("\n                     FoodItems order by you");
                                        System.out.printf("| %-15s    %-15s  %-10s|\n", "Food No", "Food Name", "Food price");
                                        int i1 = 0;
                                        System.out.println("+-------------------------------------------------------+");
                                        for (FoodItem foodItem : order.getFoodItems()) {
                                            System.out.printf("| %-15s    %-15s  %-18s|\n", ++i1, foodItem.getName(), foodItem.getPrice() + "/-");
                                        }
                                        System.out.println("+-------------------------------------------------------+");
                                        System.out.println("+----------------------------------+");
                                        System.out.println("| Total price of order is   " + order.getTotalPrice() + "/- |");
